...
<div class="page-container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="horizontal-form">
                    <form action="{{ url('/user/topup-report-export') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var url = "{{ route('/user/wallet-topup-report-data') }}";
            ...
            let dataTable = new DataTable('#datatable', {
                ...
                ajax: {
                    ...
                    data:{"type":"wallettopup",_token: '{{ csrf_token() }}'},
