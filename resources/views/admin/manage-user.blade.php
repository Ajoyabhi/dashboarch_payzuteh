                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($user as $key=>$rows)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $rows->payin_status;?>
                                                    @if($rows->payin_status == 1)

                                                            <button class="btn btn-sm btn-danger" onClick="changePayStatus({{$rows->id}},0,'payin_status', 'payin')">DEACTIVE</button>

                                                        @else

                                                            <button class="btn btn-sm btn-success" onClick="changePayStatus({{$rows->id}},1,'payin_status', 'payin')">ACTIVE</button>

                                                        @endif
                                                    </td>
                                                    <td>
                                                        <?php echo $rows->payout_status;?>
                                                        @if($rows->payout_status == 1)
        
                                                            <button class="btn btn-sm btn-danger" onClick="changePayStatus({{$rows->id}},0,'payout_status', 'payout')">DEACTIVE</button>

                                                        @else

                                                            <button class="btn btn-sm btn-success" onClick="changePayStatus({{$rows->id}},1,'payout_status', 'payout')">ACTIVE</button>
...
<?php echo $rows->status;?>
                                                        @if($rows->status == 1)
                                                            ...
                                                            <button class="btn btn-sm btn-danger" onClick="changeStatus({{$rows->id}},'DEACTIVE','status')">DEACTIVE</button>

                                                        @else

                                                            <button class="btn btn-sm btn-success" onClick="changeStatus({{$rows->id}},'ACTIVE','status')">DEACTIVE</button>
...
let table = new DataTable('#datatable');
    ...
    function changePayStatus(id,status,type, pay){
        ...
        var url = '{{url('/admin/update-users-pay-status')}}';
