    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="addbank" action="{{ route('payout-user.storeBank') }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="cus_name" class="form-control is-valid1" value="" id="cus_name" placeholder="Enter Customer Name" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="mobile_no" class="form-control is-invalid1" value="" required id="mobile_no" maxlength="10" placeholder="Enter Mobile">
