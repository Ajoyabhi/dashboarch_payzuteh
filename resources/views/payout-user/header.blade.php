...
<head>
    ...
    <title>Payout User Dashboard </title>
        ...
        <div class="layout">
            ...
            <div class="header">
                ...
                <div class="logo logo-dark">
                    Jippay
                    <!--<a href="{{ url('/payout-user/dashboard') }}">-->
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="dropdown dropdown-animated scale-left">
                            ...
                            <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                                ...
                                <a href="{{url('/payout-user/view-profile')}}" class="dropdown-item d-block p-h-15 p-v-10">
                                ...
                                <a href="{{url('/payout-user/change-password')}}" class="dropdown-item d-block p-h-15 p-v-10">
            ...
            <div class="side-nav">
                ...
                <div class="side-nav-inner">
                    ...
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li>
                            <a href="{{url('/payout-user/dopayin')}}">
                                <span class="icon-holder">
                        ...
                        <li>
                            <a href="{{url('/payout-user/dopayout')}}">
                                <span class="icon-holder">
                        ...
                        <li>
                            <a href="{{url('/payout-user/payrequest-list')}}">
                                <span class="icon-holder">
                                    <i class="anticon anticon-table"></i>
                                </span>
                        ...
                        <li>
                            <a href="{{url('/payout-user/bank-list')}}">
                                <span class="icon-holder">
                        ...
                        <!-- @if(Auth::user()->user_type == 1)
                        <li>
                            <a href="{{url('/payout-user/wallet-report')}}">
                        ...
                        <li>
                            ...
                            <a href="{{url('/payout-user/payout-report')}}">
                        ...
                        {{-- <li>
                            ...
                            <a href="{{url('/payout-user/wallet-topup-report')}}">
                        ...
                        <li>
                            <a href="{{url('/payout-user/dev-setting')}}">
                                <span class="icon-holder">
                                    <i class="anticon anticon-table"></i>
                                </span>
