                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="horizontal-form">
                            <form action="{{ url('/admin/payin-report-export') }}" method="POST" enctype="multipart/form-data">
                                @csrf
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "{{ route('/admin/payin-report-data') }}";
        ...
        let dataTable = new DataTable('#datatable', {
...

            {
                ...
                targets: 9, // Index of the column you want to modify
