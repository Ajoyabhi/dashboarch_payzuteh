                ...
                <form action="{{url('admin/save-user-charge')}}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="start_amount" placeholder="Amount Start">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Amount End</label>
                            <input type="text" class="form-control" name="end_amount" placeholder="Amount End">
                        </div>
                   
                        <div class="form-group col-md-6">
                            <label for="inputAddress">Payin Charge</label>
                            <input type="text" class="form-control" name="payin_charge" placeholder="Payin Charge">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="payout_charge" placeholder="payout Charge">
                        </div>
                        <div class="form-group col-md-6">
