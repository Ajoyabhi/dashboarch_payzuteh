    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="payout" action="{{ route('user.storePayout') }}" method="POST">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="">Amount</label>
                            <input type="text" name="amount" class="form-control is-valid1" value="" id="amount" required>                   
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="ref_number" class="form-control is-valid1" value="" id="ref_number" required>                   
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="">Descrption</label>
                            <input type="text" name="description" class="form-control is-valid1" value="" id="description">                   
                        </div>
