...
class Users extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user/dashboard',compact('data','usertransaction','usersBalances','totalTrades','totalPayin','totalPayout','todayPayout','todayPayin','todayProfit','totalProfit', 'user'));
    }
